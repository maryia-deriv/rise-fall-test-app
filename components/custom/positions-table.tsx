  ...
  return (
    <div className={cn('mt-6', className)}>
      <div className="grid grid-cols-3 items-center mb-3">
        <div />
        <h2 className="text-sm font-semibold text-center">Positions</h2>
      ...
      <div className="rounded-lg border border-border overflow-hidden">
        <Table>
          ...
          <TableBody>
            {(filter === 'open' || filter === 'all') && openPositions.map((pos) => (
              <OpenPositionRow
            ...
            {(filter === 'closed' || filter === 'all') && closedPositions.map((pos) => (
              <ClosedPositionRow
